...
void UeasyFM::Extract(
	...
	AngularVelocity = bodyInst->GetUnrealWorldAngularVelocityInRadians();
...
float UeasyFM::GetAlpha(const FTransform &Transform, FVector velocity) const {
	FVector fwdvec, upvec, rightvec;
	GetAxisVectors(Transform, fwdvec, upvec, rightvec);
...
float UeasyFM::GetSlip(const FTransform &Transform, FVector velocity) const {
	FVector fwdvec, upvec, rightvec;
	GetAxisVectors(Transform, fwdvec, upvec, rightvec);
...
void UeasyFM::GetAxisVectors(const FTransform &Transform, FVector &fwdvec, FVector &upvec, FVector &rightvec) const {
